#!/usr/bin/env python3
"""Main web application entry point for rpi_surveillance."""

from nicegui import app, ui

from rpi_surveillance.ui.login import setup_auth_middleware, logout
...
# ---------------------------------------------------------------------------
# Helper: status tile for home panel
# ---------------------------------------------------------------------------
